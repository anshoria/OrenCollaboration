            ...
            <div class="relative h-full w-full overflow-hidden">
                ...
                <div class="absolute inset-0 flex items-center justify-center">
                    <div class="text-center">
                        ...
                        <span
                            class="bg-primary-100 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-full">
        ...
        <section class="py-16 px-4 mx-auto max-w-screen-xl lg:py-24">
            <div class="grid md:grid-cols-3 gap-8">
                <div class="md:col-span-2">
                    ...
                    <div
                        class="mb-4 text-gray-600 prose max-w-none prose-headings:mb-4 prose-p:mb-4 prose-ul:mb-4 prose-ol:mb-4">
                        ...
                        <ul class="space-y-4">
                            <li class="flex items-center">
                                ...
                                <span class="text-gray-600">Date:
                                    {{ date('F d, Y', strtotime($project->date)) }}</span>
                            </li>
                            <li class="flex items-center">
                                <svg class="w-5 h-5 mr-2 text-primary-600" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
            ...
            <section class="bg-white">
                <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div class="max-w-screen-md mb-8 lg:mb-16">
                        ...
                        <p class="text-gray-500 sm:text-xl">Capturing the moments that made this event
                            truly special.</p>
                    </div>
                        ...
                        @foreach ($project->gallery as $image)
                            <div class="h-48 md:h-96">
                                <div class="relative h-full w-full overflow-hidden rounded-lg">
                                    ...
                                    <div class="absolute inset-0 animate-pulse bg-gray-200"></div>
                                    <!-- Image -->
                                    <img class="h-full w-full object-cover opacity-0 transition-opacity duration-300"
        ...
        @if ($project->review)
            <section class="py-16 px-4 mx-auto max-w-screen-xl">
                <div class="max-w-screen-md mx-auto text-center">
                    <svg class="w-10 h-10 mx-auto mb-3 text-gray-400" aria-hidden="true"
