...
@section('content')
    <section class="bg-white">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                ...
                <p class="text-gray-500 lg:mb-16 sm:text-xl">
                        ...
                        <div class="relative lg:w-2/5">
                            ...
                            <div class="relative h-64 lg:h-full w-full">
                                ...
                                <div class="absolute inset-0 animate-pulse"
                                    style="background-color: rgba(229, 231, 235, 0.5)"></div>
                                <!-- Image -->
                                <img class="w-full h-full object-cover opacity-0 transition-opacity duration-300"
                                    src="{{ asset('storage/' . $project->cover_img) }}" alt="{{ $project->title }}"
                                    loading="lazy"
                                ...
                                <!-- Category Badge -->
                                <span
                                    class="absolute bottom-3 left-3 bg-primary-100 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-full">
                        ...
                        <div class="p-5 flex flex-col justify-between lg:w-3/5">
                            <div>
                                <h3 class="text-xl font-bold tracking-tight text-gray-900">
                                    <a href="#"
                                        class="hover:text-primary-600 transition-colors duration-300">{{ $project->title }}</a>
                                </h3>
                                <p class="mb-4 text-gray-500">{{ $project->overview }}</p>
                            </div>
    ...
    <section class="bg-white">
        <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
            <figure class="max-w-screen-md mx-auto" data-aos="zoom-in">
                ...
                <figcaption class="flex items-center justify-center mt-6 space-x-3">
                    <div class="flex items-center divide-x-2 divide-gray-500">
                        ...
                        <div class="pl-1 sm:pr-3 text-sm text-gray-500">{{ $projectContent->company_review }}</div>
                    </div>
                </figcaption>
            </figure>
        </div>
