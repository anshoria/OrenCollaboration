...
@section('content')
    ...
    <section class="bg-white overflow-hidden">
        <div class="hero-swiper swiper relative w-full h-[300px] sm:h-[450px]">
                ...
                @foreach ($carousels as $carousel)
                    <div class="hero-slide swiper-slide pb-1">
                        <div class="relative h-full w-full rounded-2xl overflow-hidden shadow-lg">
                            <!-- Image container dengan loading effect -->
                            <div class="relative h-full w-full">
                                ...
                                @if ($carousel->title || $carousel->description)
                                    <!-- Content dengan gradient overlay -->
            ...
            <!-- Navigation Arrows -->
            <div
                class="hero-navigation absolute inset-x-4 top-1/2 z-50 flex items-center justify-between -translate-y-1/2 pointer-events-none">
                <button
                    class="hero-prev swiper-button-prev !static !w-12 !h-12 rounded-full bg-black/20 backdrop-blur-lg pointer-events-auto hover:bg-black/40 transition-colors duration-300 group">
                    <svg class="w-6 h-6 text-white mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                    </svg>
                </button>
                <button
                    class="hero-next swiper-button-next !static !w-12 !h-12 rounded-full bg-black/20 backdrop-blur-lg pointer-events-auto hover:bg-black/40 transition-colors duration-300 group">
                    <svg class="w-6 h-6 text-white mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Custom Bullets -->
            <div class="hero-pagination-container absolute bottom-6 left-1/2 -translate-x-1/2 z-50">
                <div
                    class="hero-pagination swiper-pagination !relative !bottom-0 !flex gap-2 bg-black/20 backdrop-blur-lg px-3 py-2 rounded-full">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="max-w-screen-md mb-8 lg:mb-16">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900">Why Choose
                    OrenCollaboration?</h2>
    ...
    <section class="bg-white py-8 sm:py-12 md:py-16 px-4">
        <div class="max-w-screen-xl mx-auto">
            <h2 class="text-3xl sm:text-4xl font-extrabold text-center text-gray-900 mb-4 sm:mb-6 md:mb-8">
                Apa Kata Klien Kami</h2>
            <p class="text-lg sm:text-xl text-center text-gray-600 mb-8 sm:mb-10 md:mb-12">
                {{ $home->review_subheading }}
            </p>

            <div class="relative testimonial-container px-4">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        @foreach ($testimonials as $testimonial)
                            <div class="swiper-slide p-4">
                                <div
                                    class="bg-white rounded-xl shadow-lg p-6 relative transform transition-transform duration-300 h-full">
                                    <!-- Quote icon -->
                                    <div
                                        class="absolute -top-4 -right-4 bg-primary-500 w-8 h-8 rounded-full flex items-center justify-center shadow-lg">
                                        <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                                            <path
                                                d="M11.42 9.87c-.5 1.17-2 2.13-3.42 2.13-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4c0 .73-.2 1.41-.54 2l.96 4.89L9.5 14l1.92-4.13zM20.42 9.87c-.5 1.17-2 2.13-3.42 2.13-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4c0 .73-.2 1.41-.54 2l.96 4.89L18.5 14l1.92-4.13z" />
                                        </svg>
                                    </div>

                                    <div class="flex flex-col h-full">
                                        <p
                                            class="text-gray-700 mb-6 italic text-sm sm:text-base leading-relaxed">
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center">
                ...
                <a href="{{ route('contact') }}"
                    class="text-white bg-orange-600 hover:bg-orange-700 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none">Contact
                    Us</a>
            </div>
        </div>
    </section>
